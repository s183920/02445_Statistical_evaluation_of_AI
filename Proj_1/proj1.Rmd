...
rgl::lines3d(x = data_long$x, y = data_long$y, z = data_long$z, col = data_long$experiment, alpha = 1, xlab = 'x', ylab = 'y', zlab = 'z', lwd = .1, legend = T)
rgl::title3d("Trajectories")
rgl::axes3d(edges = "bbox", xlab = "x", ylab = "y", zlab = "z", pos = c(0,0,0))
rgl::legend3d("bottom", data_long$experiment)

rgl::segment3d(x = data_long$x, y = data_long$y, z = data_long$z, col = data_long$experiment, alpha = .3)
...
rgl::axes3d(labels = T, edges = "bbox")
